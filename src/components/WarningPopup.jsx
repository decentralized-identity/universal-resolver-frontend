...
export class WarningPopup extends Component {
	...
	render() {
		return (
			<Modal trigger={this.props.trigger} className="warning-popup">
				<Modal.Header>
				...
				<Modal.Content>
					<Modal.Description>
						...
						<p>DIDs and DID Resolution are by definition meant to be decentralized. We are running an
						instance of the Universal Resolver, but you should not rely on this
						instance for anything other than development and non-critical demos. From your perspective,
						you should treat this instance as an untrusted third party that could theoretically manipulate
